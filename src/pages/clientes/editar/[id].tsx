    ...
    <Page titulo="Editar Cliente" subtitulo="" nomeUsuario="">
        <div className="mt-6 container mx-auto pt-4 shadow rounded-md bg-slate-50">
            ...
            <form onSubmit={handleSubmit} className="max-w-full mx-auto">
                ...
                <Link type="button" className="rounded-md bg-slate-700 px-3 py-2 text-sm font-semibold leading-6 text-white" href={`/logradouros/logradouros?id=${registro.clienteId}`}>Novo Endereço</Link>     
